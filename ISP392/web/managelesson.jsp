...
<html lang="en">
    ...
    <body>
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <c:forEach items="${listLessonByPageing}" var="l" >  					
                                <tr>
                                    <td>
                                        <span class="custom-checkbox">
                                    ...
                                    <td>${l.description}</td>
                                    <td>         
                                        <i onclick="edit(${l.lessonID})" class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                        <i onclick="confirmDelete(${l.lessonID})" class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i>
                                    </td>
                                </tr> 
                            </c:forEach>  
                        </tbody>
                    ...
                    <form action="addlesson" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="urlVideo" type="text" class="form-control" required>
                            </div>
        ...
        <div class="container">
            <c:choose>
                <c:when test="${listLessonByPageing == null || listLessonByPageing.size() ==0}">
                    Not have any Course
                </c:when>
