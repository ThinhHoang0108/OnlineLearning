...
public class DashboardController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            List<Register> listRegister = new RegisterDAO().getAllToday();
            List<Comment> listComment = new CommentDAO().getAllCommentToday();
            int totalRegister = new RegisterDAO().getTotalRegister();
            int totalCourse = new CourseDAO().getTotalCourse();
            int totalLesson = new LessonDAO().getTotalLesson();
            int totalUser = new UserDAO().getNumberUser();
