                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="sidebar">
                                ...
                                <div class="sidebar-item recent-posts">
                                    <h3 class="sidebar-title">Another Blogs</h3>

                                    <div class="mt-3">
                                        <c:forEach items="${sessionScope.listTop3BlogNew}" var="t">
                                            <div class="post-item mt-3">
                                                <img src="${t.thumnailURL}"alt="">
                                                <div>
                                                    <h4><a href="blogdetail?blogID=${t.id}">${t.content}</a></h4>
                                                    <time datetime="">${t.createDate}</time>
                                                </div>
